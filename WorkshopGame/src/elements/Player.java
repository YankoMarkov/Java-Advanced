...
public class Player extends Element {
    ...
    private int gold;
    private List<workshopGame.elements.Village> villages;
    private String type;
    private int damage;
    private int health;
    ...
    public Player(int gold, String type, Game game) {
        super(game);
        this.gold = gold;
        this.villages = new ArrayList<workshopGame.elements.Village>();
        this.type = type;
        this.health = HEALTH;
    }

    public void addVilage(workshopGame.elements.Village v) {
        this.villages.add(v);
    }
