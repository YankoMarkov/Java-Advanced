...
public class Game {
    ...
    private elements.Player playerOne;
    private elements.Player playerTwo;
    private elements.Player currentPlayer;
    ...
    public Game() {
        this.playerOne = new elements.Player(0, "Player One", this);
        this.playerTwo = new elements.Player(0, "Player Two", this);
    ...
    public elements.Player getPlayerOne() {
        return playerOne;
    }

    public void setPlayerOne(elements.Player playerOne) {
        this.playerOne = playerOne;
    }

    public elements.Player getPlayerTwo() {
        return playerTwo;
    }

    public void setPlayerTwo(elements.Player playerTwo) {
        this.playerTwo = playerTwo;
    }

    public elements.Player getCurrentPlayer() {
        return currentPlayer;
    }

    public List<List<elements.Element>> getMap() {
        return map;
    }
